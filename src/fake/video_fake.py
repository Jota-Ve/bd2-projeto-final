...
class VideoFake(dado_fake.DadoFake):
    ...
    @property
    def pk(self) -> T_pk: return (self.nro_plataforma, self.nome_canal, self.titulo, self.datah)

    @property
    def dados(self) -> T_dados: return (self.tema, self.duracao_segs, self.visu_simul, self.visu_total)
    ...
    def gera(cls, quantidade: int, faker: fkr.Faker, *args: Any, canais: Sequence[canal_fake.CanalFake], **kwargs: Any) -> tuple[Self, ...]:
        ...
        temas_possiveis: list[str] = [
            ...
            'Axé', 'Beleza', 'Biologia', 'Blockchain', 'Blues', 'Breaking Bad', 'Call of Duty', 'Capitalismo', 'Carros',
            'Chuck Palahniuk', 'Ciência', 'Cinema', 'Clássica', 'Comédia', 'Comunismo', 'Cosplay', 'Country', 'Culinária',
            'Cultura Pop', 'Cultura', 'Dark Souls', 'DC Comics', 'Democracia', 'Desafios', 'Desenvolvimento de Software',
            'Design', 'Disco', 'Divorced Dad Rock', 'DIY', 'Documentários', 'Dororo', 'Dragon Ball', 'Ecologia', 'Educação',
            'Elden Ring', 'Eletrônica', 'Engenharia', 'Entrevistas', 'Esportes', 'Eventos Esportivos', 'Eventos', 'Fandoms',
            'Filosofia', 'Finanças', 'Física', 'Fitness', 'Forró', 'Fotografia', 'Funk', 'Game of Thrones', 'Gameplay',
            'Hip-Hop', 'História', 'Imóveis', 'Influenciadores', 'Inteligência Artificial', 'Investimentos', 'Isaac Asimov',
            'J-Pop', 'Jazz', 'Jogos de Tabuleiro', 'Jogos', 'K-Pop', 'Kassino', 'Leninismo', 'Literatura', 'Lives',
            'Machine Learning', 'Mangás', 'Maoismo', 'Marketing', 'Marvel', 'Marxismo', 'Matemática', 'Medicina', 'Moda',
            'Música', 'Naruto', 'Natureza', 'Negócios', 'Notícias', 'O Som da Noite', 'Podcasts', 'Política', 'Pop',
            'Programação', 'Psicologia', 'Publicidade', 'Química', 'Reações', 'Realidade Aumentada', 'Realidade Virtual',
            'Redes Sociais', 'Reggae', 'Reviews', 'Rock', 'Samba', 'Saúde', 'Socialismo', 'Sociologia', 'Star Wars',
            'Summer Eletro Hits', 'Tecnologia', 'Tutoriais', 'Unboxings', 'Viagens', 'Vlogs'
        ]
